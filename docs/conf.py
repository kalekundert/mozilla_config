# -*- coding: utf-8 -*-
#
# Backup Firefox documentation build configuration file, created by
...
version = backup_firefox.__version__
# The full version, including alpha/beta/rc tags.
release = backup_firefox.__version__
...
man_pages = [
    ('index', 'cookiecutterproject_name', u'Backup Firefox Documentation',
     [u'Kale Kundert'], 1)
]
